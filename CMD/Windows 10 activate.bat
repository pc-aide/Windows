::------------------------------------------------------------------------------------
:: Windows 10 activate by KMS Server
:: Elevated : yes
:: SRC https://get.msguides.com/windows10.txt
:: Goal: Only for LAB & testing - take care with script - no guarantee
::
:: Tested on --> Win 10 1803 {Pro,Home,Education} --> OK
:: O/P --> https://imgur.com/a/fLkYdAl
::
:: Tested on --> Win 10 1803 FRE Education --> fail --> updgrate OS to Pro
:: O/P --> http://pix.toile-libre.org/upload/original/1547999183.png
::
:: Tested on --> Win 10 1809 {Enterprise} --> Expire 12/10/2020
::------------------------------------------------------------------------------------
